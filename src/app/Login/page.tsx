...
// const LoginPage = () => {
//   return (
//     <div className='w-90 h-80 px-8 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex flex-col items-center justify-center gap-4'>
...
//       className='border-2 px-2 py-1 w-full' />
//       <button className='border-2 px-2 py-1 w-full cursor-pointer'>Login</button>
//       <label htmlFor=""></label>
//     </form>
//     </div>
//   )
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  onChange={handleInputChange}
                  className="h-4 w-4 text-purple-400 focus:ring-purple-400 border-gray-300 rounded bg-white/10"
                />
