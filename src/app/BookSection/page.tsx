...
//   /* displayedBooks: Initialized with initialBooks, holds the list of books currently shown in the grid.

//   showingAll: A boolean (initially false) tracking whether the "View All Books" button has been clicked. */
...
//     if (showingAll) {
//       /*
// Appends the initialBooks array to the current displayedBooks array using the spread operator ([...displayedBooks, ...initialBooks]).

// This simulates loading more books by duplicating the initial list. */
//       setDisplayedBooks([...displayedBooks, ...initialBooks]);
//     } else {
//       /* Sets displayedBooks to include the initial books plus another copy of initialBooks, effectively doubling the list.

// Sets showingAll to true to indicate that the initial "View All Books" action has occurred. */
